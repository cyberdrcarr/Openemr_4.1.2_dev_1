...
e.stopPropagation();
	...
	if(td.length){
	var _47c=td.attr("field");
	opts.onRowMouseoverMenu.call(_46e,_47b,_47c,row[_47c], row);
	}
	...
	e.stopPropagation();
		...
		if(td.length){
		var _47c=td.attr("field");
		opts.onRowMouseoutMenu.call(_46e,_47b,_47c,row[_47c]);
		}
		if(opts.singleSelect==true){
			//_4bf(_46e,_47b);
		}else{
		...
		if(opts.onRowMouseoutMenu){
			opts.onRowMouseoutMenu.call(_46e,_47b,row);
			}
...
},onRowMouseoverMenu:function(e,_64f){
	opts.onRowMouseoverMenu.call(_63d,e,find(_63d,_64f));
	},onRowMouseoutMenu:function(e,_64f){
		opts.onRowMouseoutMenu.call(_63d,e,find(_63d,_64f));
	}
}));
if(opts.pagination){
